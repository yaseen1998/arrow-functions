...
const addOneLiner = (num1, num2) => ` ${num1} + ${num2} = ${num1 + num2,5}`;
...
const sumOneLinear = (a, b,c,d) => `${a+b+c+d}`;
console.log(sumOneLinear(1, 2, 3, 4));
...
const newsumAndProduct = (a, b,sum,product) => ([sum= a+b , product = b*a])
...
//it is the costructor function
// 2. What is "this" when joe.scopeArrow() is invoked?
//it si this for scopArrow
// 3. Explain why "this" is different when an arrow function is used.
// because the arrow function it use this for parent
